function [abs_echograms, rec_echograms, echograms] = compute_echograms_sh(room, src, rec, abs_wall, imgSrcOrder, rec_orders)
...
for ns = 1:nSrc
    for nr=1:nRec
        ...
        % compute echogram
        abs_echograms(ns, nr, :) = absorption_module(rec_echograms(ns,nr), abs_wall);
    end
end
